...
export const AuthForm: React.FC<AuthFormProps> = ({ 
  ...
  // Determine the actual mode - prioritize explicit mode over isRegister
    ...
    try {
      if (actualMode === 'signup') {
        ...
        if (userType === 'restaurant') {
          // Create restaurant profile with fallback coordinates
      ...
      <CardContent>
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <Button type="submit" disabled={loading} className="w-full">
            {loading ? 'Loading...' : (actualMode === 'signup' ? 'Sign Up' : 'Login')}
          </Button>
        </form>
      </CardContent>
    </Card>
