...
class SupportTicketService {
  ...
  async createTicket(
    ...
    try {
      // Don't include ticket_number in the insert - it will be auto-generated by the trigger
      ...
      if (deliveryAssignmentId) insertData.delivery_assignment_id = deliveryAssignmentId;
      if (attachments) insertData.attachments = attachments;
